...
object ObservationFixtures {
    ...
    val summerSolsticeTropicCancerZenith = SolarTestCase.Observation(
        name = "EPHEMERIS-ALTITUDE-S1_1 - should be near zenith " +
            "(89.99°) at Tropic of Cancer on Summer Solstice 2026",
    ...
    val winterSolsticeTropicCapricornZenith = SolarTestCase.Observation(
        name = "EPHEMERIS-ALTITUDE-S1_2 - should be near zenith " +
            "(89.99°) at Tropic of Capricorn on Winter Solstice 2026",
    ...
    val northPoleMidnightSun = SolarTestCase.Observation(
        name = "EPHEMERIS-ALTITUDE-S1_3 - should show Midnight Sun " +
            "(~ +23.44°) at North Pole on Summer Solstice 2026",
    ...
    val southPolePolarNight = SolarTestCase.Observation(
        name = "EPHEMERIS-ALTITUDE-S1_4 - should show Polar night " +
            "(~ -23.44°) at South Pole on Winter Solstice 2026",
    ...
    val greenwichEquationOfTimePeak = SolarTestCase.Observation(
        name = "EPHEMERIS-ALTITUDE-S1_5 - should have correct altitude " +
            "(~ 23.38) at Greenwich during Equation of Time peak (Autumn 2026)",
    ...
    val internationalDateLineSunset = SolarTestCase.Observation(
        name = "EPHEMERIS-ALTITUDE-S1_6 - should be near horizon " +
            "(~ 1.8°) at International Date Line on March Equinox",
    ...
    val pragueSummerSolsticeSolarNoon = SolarTestCase.Observation(
        name = "EPHEMERIS-ALTITUDE-S1_7 - should have correct noon altitude " +
            "(~ 61.35° ) in Prague on Summer Solstice 2026",
