...
## ⚠️ PERM_SETTINGS_S1_VM_1 - should set Idle after returning from settings
## ⚠️ PERM_SETTINGS_S1_VM_2 - should start fresh Education flow when card is tapped after returning from Settings
## ⚠️ PERM_SETTINGS_S2_VM_1 - should show Education dialog on next tap after user grants it in Settings
## ⚠️ PERM_SETTINGS_S3_VM_1 - should keep DeniedPermanently when settings ignored
